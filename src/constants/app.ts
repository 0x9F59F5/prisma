...
export const BASE_URL = 'https://prisma-api.onrender.com';
export const BASE_URL_DEV = 'http://localhost:7456';

export const BASE_WS_URL = 'wss://prisma-api.onrender.com';
export const BASE_WS_URL_DEV = 'ws://localhost:7456';

export const IS_PROD = process.env.NODE_ENV === 'production';

export const LOCAL_STORAGE_KEY = 'prisma';
export const LOCAL_STORAGE_LIBRARY_KEY = 'prisma-library';
export const LOCAL_STORAGE_THEME_KEY = 'prisma-theme';
export const LOCAL_STORAGE_COLLAB_KEY = 'prisma-collab';

export const WS_THROTTLE_MS = 16;

export const PROJECT_FILE_EXT = 'prisma';
